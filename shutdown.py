...
while True: #Inserir código dentro no while do programa
    if api.get_battery_level() <= level_battery:  #Se o nível de bateria cai abaixo de um certo valor o sistema habilita o evento de falta de energia,logo só desligará se estiver sem energia da rede e abaixo do nível especificado.                                                  
